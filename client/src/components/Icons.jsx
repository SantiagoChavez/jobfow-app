...
export const RadarIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10" stroke="#38BDF8" strokeOpacity="0.4" />
    <circle cx="12" cy="12" r="6" stroke="#38BDF8" strokeOpacity="0.7" />
    <circle cx="12" cy="12" r="2" fill="currentColor" stroke="currentColor" />
    <line x1="12" y1="12" x2="20" y2="8" stroke="currentColor" strokeWidth="2.5" />
  </svg>
);
...
export const KanbanIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
