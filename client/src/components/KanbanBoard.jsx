      ...
      {COLUMNS.map((col) => {
        ...
        return (
          ...
          >
            ...
            {/* Listado de Tarjetas */}
            <div className="flex flex-col gap-2.5 flex-1 overflow-y-auto max-h-[calc(100vh-280px)] pr-0.5">
              {columnApps.length === 0 ? (
                ...
                columnApps.map((app) => (
                  <div
                    ...
                    className="group relative p-3.5 rounded-xl bg-navy-base/80 hover:bg-navy-surface border border-slate-800 hover:border-slate-600/80 transition-all duration-200 cursor-pointer shadow-sm hover:shadow-md hover:-translate-y-0.5"
                  >
                    {/* Fila Empresa y Días */}
